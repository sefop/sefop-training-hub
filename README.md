...
| [Brownfield Adoption Guide](guides/brownfield-adoption-guide.md) | How to safely modify and modernize a legacy system.                                                                              | Scientists & Engineering Managers |
| [Protocol to Fix a Bug](guides/protocol-to-fix-a-bug.md) | A disciplined process for fixing bugs: triage whether it's worth fixing, find the root cause, and prevent it from recurring with an automatic test. | Scientists & Engineering Managers |

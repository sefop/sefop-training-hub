...
| 06 | [Deploying decision-support software](book/06-delivering/README.md) | • How do I deploy a model, with its solver and data, so it delivers a usable decision on every run?<br>• How do I release a new model without putting current decisions at risk?<br>• What should I measure in production to know whether the decisions are still good? |

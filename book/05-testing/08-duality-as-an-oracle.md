...
> **Audience:** Scientists · **Prerequisites:** [02](02-why-optimization-models-are-hard-to-test.md), [03](03-test-the-contract-not-the-algorithm.md) · **Status: coming soon**
...
[Chapter 02](02-why-optimization-models-are-hard-to-test.md) argued that checking feasibility is cheap while proving
...
[← 07 When optimality is not guaranteed](07-when-optimality-is-not-guaranteed.md) · [Next: 09 Testing a Pareto front →](09-testing-a-pareto-front.md)
